...
class ExceptionsTest {
  ...
  void testSupabaseConnectionException() {
    SupabaseConnectionException ex = new SupabaseConnectionException("Supabase operation Error",
  ...
  void testEmailSendException() {
    EmailSendException ex = new EmailSendException("Email sending Error",
        new RuntimeException("test error"));
