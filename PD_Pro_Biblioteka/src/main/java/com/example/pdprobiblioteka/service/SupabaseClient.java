...
/**
 * Klasa odpowiedzialna za komunikację z bazą danych Supabase poprzez WebClient.
 * Umożliwia wykonywanie operacji CRUD na różnych encjach takich jak Użytkownicy, Książki,
 * Wypożyczenia, Kary itp.
 * Zawiera również integrację z serwisem EmailService do wysyłania wiadomości e-mail.
 */
@Service
public class SupabaseClient {
  ...
  /**
   * Sprawdzanie bezpieczenstwa przekazanej wartości w kontekście SQL injection
   * wykorzystywana w filtrowaniu książek.
   *
  ...
  /**
   * Aktualizuje dane administratora na podstawie przekazanego admina.
   * Aktualizowane są tylko te pola, które nie są nullem.
   *
  ...
  /**
   * Aktualizuje dane autora o określonym identyfikatorze.
   * Aktualizowane są tylko pola niebędące nullem.
   *
  ...
  /**
   * Zaplanowane zadanie dodające automatyczne kary za przetrzymanie książek.
   * Sprawdza wszystkie wypożyczenia i dodaje karę użytkownikowi,
   * jeśli termin oddania minął, a książka nie została jeszcze zwrócona.
  ...
  /**
   * Pobiera dane z tabeli na podstawie określonego filtru, wykorzystywane
   * do pobierania przez klucz obcy.
   *
   * @param table nazwa tabeli.
  ...
  /**
   * Pobiera książki oraz autorów spełniających przekazane warunki
   * i filtruje książki, których autorzy są zgodni z wynikami filtrowania.
   *
  ...
  /**
   * Pobiera dane użytkownika na podstawie loginu i hasła.
   * Waliduje dane wejściowe pod kątem bezpieczeństwa.
   *
   * @param table nazwa tabeli.
   * @param columns kolumny do pobrania.
  ...
  /**
   * Sprawdzanie, czy obiekt jest bezpieczny poruwnując go patternem.
   *
  ...
  /**
   * Wysyła dane do wybranej tabeli.
