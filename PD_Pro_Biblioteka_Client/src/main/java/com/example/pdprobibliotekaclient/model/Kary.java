...
public class Kary {
  ...
  public DoubleProperty KwotaProperty() {
    return Kwota;
  }

  public StringProperty Data_Wydania_Kary_Property() {
    return Data_Wydania_Kary;
  }

  public StringProperty Termin_Zaplaty_Property() {
    return Termin_Zaplaty;
  }

  public BooleanProperty CzyZaplaconoProperty() {
  ...
  public String toString() {
    return "Kary{id=" + id + ", Kwota=" + Kwota + ", Data_Wydania_Kary=" + Data_Wydania_Kary
        + ", Termin_Zaplaty=" + Termin_Zaplaty + ", Czy_Zaplacono=" + Czy_Zaplacono
