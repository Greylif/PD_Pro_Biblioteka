...
public class Filtr {
  ...
  public String getAutorName() {
    return autorName.get();
  }

  public void setAutorName(String value) {
    autorName.set(value);
  }

  public StringProperty autorDataProperty() {
    return autorName;
  }

  public int getIdPlacowki() {
    return idPlacowki.get();
  }

  public void setIdPlacowki(int value) {
    idPlacowki.set(value);
  }
  ...
  public Boolean isCzyWypozyczono() {
    return czyWypozyczono.get();
  }
  ...
  public void setCzyWypozyczono(Boolean czyWypozyczono) {
    this.czyWypozyczono.set(czyWypozyczono);
  }
  ...
  public BooleanProperty czyWypozyczonoProperty() {
    return czyWypozyczono;
  }
